...
Sales by Store Location: Visualise the distribution of sales across different store locations using bar charts.
Most Popular Products: Identify the top 5 most popular products.
Organic Coffee Analysis: Understand the distribution of organic coffee sales using pie charts.
Eco-Friendly Cup Analysis: Analyse the usage of eco-friendly cups with pie charts.
...
Save the logo1.png file in the correct path on your machine or update the st.image() path to match your logo location.
...
Histogram visualising the distribution of unit prices.
7. Revenue Calculation
Bar Chart summarising revenue by product type.
🖼 Logo
...
Customise the app further by adding new analysis types or visualisations as needed.
🧰 Dependencies
Python 3.7+
Libraries:
pandas
...
matplotlib
📝 License
This project is licensed under the MIT License. Feel free to use and customise the app for your needs.
